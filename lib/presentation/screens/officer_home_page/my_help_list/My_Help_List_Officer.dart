...
import 'package:traffic_police/presentation/screens/officer_home_page/my_help_list/Add_Help_Float.dart';
...
class MyHelpListOfficer extends StatefulWidget {
  @override
  State<MyHelpListOfficer> createState() => _MyHelpListOfficerState();
}

class _MyHelpListOfficerState extends State<MyHelpListOfficer> {
  @override
  Widget build(BuildContext context) {
    final isKeyboard = MediaQuery.of(context).viewInsets.bottom != 0;
    return BlocProvider<HelpBloc>(
      create: (context) => HelpBloc()..add(FetchHelpByOfficer()),
      child: Builder(
          builder: (buildContext) => Scaffold(
                appBar: usableAppbar(isHome: false, name: "My Helps"),
